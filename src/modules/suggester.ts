...
class Suggest<T> {
    ...
    constructor(
        ...
        containerEl.on(
            "click",
            ".suggestion-item",
            this.onSuggestionClick.bind(this) as (event: MouseEvent, el: HTMLElement) => void
        );
        containerEl.on(
            "mousemove",
            ".suggestion-item",
            this.onSuggestionMouseover.bind(this) as (event: MouseEvent, el: HTMLElement) => void
        );
    ...
    setSelectedItem(selectedIndex: number, scrollIntoView: boolean) {
        ...
        console.log(prevSelectedSuggestion)
